...
Lead and opportunity analysis using SQL, Excel, Power BI, and Tableau to track sales funnel performance, conversions, and revenue trends through interactive dashboards and actionable business insights.

📌 Project Overview

This is an end-to-end CRM Analytics project focused on analyzing Leads and Opportunities across the sales pipeline.
The project includes data cleaning, transformation, relational data modeling, KPI creation, and visualization to help stakeholders monitor lead flow, opportunity conversion, and revenue performance.
...
Detected bottlenecks in opportunity stages across the sales funnel.

Evaluated pipeline accuracy using expected vs forecasted revenue comparisons.
...
Add win-loss and churn analysis
